  ...
  return (
    <>
      <button
        ...
        aria-label="Report an urgent bug"
        className={cn(
          "fixed bottom-24 right-4 z-30 flex h-11 w-11 items-center justify-center rounded-full",
          "bg-negative text-white shadow-lg shadow-negative/30 hover:opacity-90",
