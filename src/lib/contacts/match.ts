...
/** The part before "@", lowercased — a contact's real email (gmail.com, etc.)
 * and a UPI id (okaxis, ptsbi, ...) are different domains, but people very
 * often reuse the same handle for both, e.g. tanya1999rathi@gmail.com and
 * tanya1999rathi@okaxis. */
